...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"insert into tblappointment(AptNumber,Name,Email,PhoneNumber,AptDate,AptTime,Services,artist) value('$aptnumber','$name','$email','$phone','$adate','$atime','$services','$artist')");
    if ($query) {
...
<html lang="en">
  ...
  <body>
    ...
    <section id="home-section" class="hero" style="background-image: url(images/pedicure.jpg);" data-stellar-background-ratio="0.5">
    		...
    		<div class="row no-gutters d-md-flex justify-content-end">
              ...
              ?>
		                       ...
		                       <?php } ?> 
													...
													<select name="artist" id="artist" required="true" class="form-control">
		                      	<option value="">Select Salon Artist</option>
		                      	<?php $query=mysqli_query($con,"select * from usersl");
              while($row=mysqli_fetch_array($query))
              {
              ?>
